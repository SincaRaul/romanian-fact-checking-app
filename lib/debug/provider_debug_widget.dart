...
import '../features/home/home_providers.dart' as home_providers;

/// Widget de debug pentru a monitoriza provider-ii în timp real
class ProviderDebugWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final stats = ref.watch(home_providers.statsProvider);
        ...
        child: Column(
          ...
          children: [
            ...
            latestFactChecks.when(
              data: (checks) => Text('  ✅ ${checks.length} fact-checks'),
            ...
            homeStatistics.when(
              data: (stats) => Text(
                '  ✅ Total: ${stats['total']}, Auto: ${stats['autoGenerated']}, Manual: ${stats['manual']}',
              ),
              loading: () => const Text('  ⏳ Loading...'),
              error: (e, _) => Text('  ❌ Error: $e'),
            ),
            ...
            stats.when(
              data: (statsData) => Text(
                '  ✅ Count: ${statsData['newCount']}, Auto%: ${statsData['autoGeneratedPct']}, Edit%: ${statsData['editorialPct']}',
              ),
              loading: () => const Text('  ⏳ Loading...'),
              error: (e, _) => Text('  ❌ Error: $e'),
            ),
